...
#Original: axg2016/16-QAM-QPSK-BPSK
#original MATLAB is being translated to Python
...
Es_BPSK = Eb*np.log2(sym_BPSK);
Es_QPSK = Eb*np.log2(sym_QPSK);
Es_QAM = Eb*np.log2(sym_QAM);
...
totalerrorcount_BPSK = np.zeros(1,7);
totalerrorcount_QPSK = np.zeros(1,7);
totalerrorcount_QAM = np.zeros(1,7);
