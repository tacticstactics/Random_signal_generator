...
fig1 = plt.figure(figsize = (5,3), facecolor='lightblue')
ax11 = fig1.add_subplot(2, 1, 1)
ax12 = fig1.add_subplot(2, 1, 2)

ax11.plot(np.real(TX_bit))
ax12.plot(np.real(TX_16QAM))
...
ax21.semilogy(power_range, BER_QPSK[0,:], label="QPSK")
ax21.semilogy(power_range, BER_16QAM[0,:], label='16QAM')
ax21.semilogy(power_range, BER_64QAM[0,:], label="64QAM")
ax21.legend(bbox_to_anchor=(1, 1), loc='upper right', borderaxespad=0, fontsize=18)
#ax21.ylim(10**(-5), 10**(-0))
#ax21.xlabel('Eb/N0 [dB]')
#ax21.ylabel('BER')
